...
<head>
        <title>Furns Furniture || Cake Details</title>
        ...
        <section class="our_cakes_area p_100">
        	<div class="container">
        		<div class="main_title">
        			<h2>Our Categories wise Furniture</h2>
        			<h5>The furniture which gives you more comfort that you can select for your home.</h5>
        		</div>
...
?>
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							<div class="cake_img">
								<img src="admin/itemimages/<?php echo $row['Image'];?>" width="250" height="200">
							</div>
							<div class="cake_text">
