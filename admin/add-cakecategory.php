...
if(isset($_POST['submit']))
  {
    ...
    if($result>0){
$msg="This Cakecategory is already exist";
    }
    ...
    {
     echo '<script>alert("This Cakecategory is already exist")</script>';
    }
}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                ...
                                                <input id="categoryname" name="categoryname" maxlength="25"
                                                type="text" class="form-control required" required="true">
                                            </div>
                                            <div class="form-group">
