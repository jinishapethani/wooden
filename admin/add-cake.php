              ...
              <option value="<?php echo $row['CategoryName'];?>"><?php echo $row['CategoryName'];?></option>
                  <?php } ?>  
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Item Name:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" maxlength="25" name="itemname" required="true"></div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Quantity:</label>
                                                <div class="col-sm-10"><input type="text" maxlength="4" pattern="[0-9]{1,2,3,4}" class="form-control" name="quantity" required="true"></div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Price:</label>
                                                <div class="col-sm-10"><input type="text" maxlength="4" pattern="[0-9]{2,3,4}" class="form-control" name="price" required="true"></div>
                                            </div>
