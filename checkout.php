...
<head>
        <title>Furns Furniture || Checkout Page</title>
                		...
                		<div class="billing_form_area">
                			<form class="billing_form row" action="" method="post" id="contactForm">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" name="streename" maxlength="20" placeholder="Street Name" class="form-control" required="true">
								</div>
								<div class="form-group col-md-12">
								    <label for="company">Area</label>
									<input type="text" name="area"  maxlength="20" placeholder="Area" class="form-control" required="true">
								</div>
								<div class="form-group col-md-12">
								...
								<div class="form-group col-md-12">
									...
									<input type="text" name="city" placeholder="City"  maxlength="20" class="form-control" equired="true">
								</div>
