        ...
        <section class="our_cakes_area p_100">
        	<div class="container">
        		<div class="main_title">
        			<h2>Our Furniture</h2>
        			<h5>Find your comfort with our furniture. Our furniture can give you the best idea to decore your home.</h5>
        		</div>
...
?>
					<div class="col-lg-3 col-md-4 col-6">
						<div class="cake_feature_item">
							<div class="cake_img">
								<img src="admin/itemimages/<?php echo $row['Image'];?>" width="280" height="230">
							</div>
							<div class="cake_text">
