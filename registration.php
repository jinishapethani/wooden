...
<head>
        <title>Furns Furniture || Sign Up</title>
...
function One(){
    ...
    if(name==null || name=='' || !firstname.test(name)){
      Swal.fire({
        icon:'error',
        title:'invalid',
    ...
    echo $msg;
       					...
       					<form class="row contact_us_form"action="" 
                name="signup" method="post" onsubmit="return checkpass();  ">
							<div class="form-group col-md-6">
								<input type="text" class="form-control" id="name" name="firstname" maxlength="15" required="true" maxlength="10"
                 placeholder="First Name"  ;>
							</div>
              <div class="form-group col-md-6">
                <input type="text" class="form-control"id="name" maxlength="15" id="lastname" name="lastname" placeholder="Last Name" required="true">
              </div>
              <div class="form-group col-md-6">
